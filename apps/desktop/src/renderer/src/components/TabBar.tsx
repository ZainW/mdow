...
export function TabBar() {
  ...
  return (
    <div className="flex h-(--tabbar-height) shrink-0 items-stretch border-b border-border-subtle bg-background">
      <div
        ...
        {tabs.map((tab, index) => {
          ...
          return (
            <ContextMenu key={tab.id}>
              <ContextMenuTrigger className="contents">
                ...
                >
                  ...
                  >
                    ...
                    >
                      <X
                        className="size-(--button-sm-icon-size)"
              ...
              <ContextMenuContent className="min-w-[212px]">
                ...
                <ContextMenuSeparator />
                <ContextMenuItem onClick={() => setPaneTab('primary', tab.id)}>
                  Open in Left Pane
                </ContextMenuItem>
                <ContextMenuItem onClick={() => setPaneTab('secondary', tab.id)}>
                  Open in Right Pane
                </ContextMenuItem>
                <ContextMenuSeparator />
      ...
      <div className="flex shrink-0 items-center border-l border-border-subtle px-1.5">
        <Button
          ...
          size="icon-sm"
          aria-label={splitView ? 'Close split view' : 'Open side-by-side view'}
          title={splitView ? `Split view on: ${activePane} pane active` : 'Open side-by-side view'}
