...
function InputGroupAddon({
  ...
  return (
    // oxlint-disable-next-line jsx-a11y/no-noninteractive-element-interactions, jsx-a11y/no-static-element-interactions -- addon is a visual sibling of the input that delegates focus on click; the input itself remains the keyboard-reachable control
    <div
